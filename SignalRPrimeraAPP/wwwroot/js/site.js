...
function dragElement(elmnt) {
    ...
    function elementDrag(e) {
        ...
        //envio de mensaje a los otros 

        conexion.invoke("EnviarPosicion", (elmnt.offsetLeft - pos1) ,(elmnt.offsetTop - pos2)).catch(function (err) {
...
conexion.on("RecibirPosicion", function (left, top) {
